...
class KafkaTest {
  ...
  def testGenerateDelegationTokenPasswordDisabled(): Unit = {
    ...
    originalProps.put(generatorKeyFor(DelegationTokenManagerConfigs.DELEGATION_TOKEN_SECRET_KEY_ALIAS_CONFIG), "echo M4573RK3Y")
    ...
    assertFalse(generated.containsKey(DelegationTokenManagerConfigs.DELEGATION_TOKEN_SECRET_KEY_ALIAS_CONFIG))
  }
  ...
  def testGenerateDelegationTokenPasswordEnabled(): Unit = {
    ...
    val generated = Kafka.generateDelegationTokenPassword(originalProps)
    assertFalse(originalProps.containsKey("delegation.token.enable"))
    assertEquals("M4573RK3Y", generated.getProperty(DelegationTokenManagerConfigs.DELEGATION_TOKEN_SECRET_KEY_ALIAS_CONFIG).trim )
  }

  @Test
  def testGenerateDelegationTokenPasswordDisabledWithSecretKey(): Unit = {
    val originalProps = new Properties
    originalProps.put("delegation.token.enable", "false")
    ...
    assertFalse(originalProps.containsKey("delegation.token.enable"))
    assertFalse(generated.containsKey(DelegationTokenManagerConfigs.DELEGATION_TOKEN_SECRET_KEY_CONFIG))
  }

  @Test
  def testGenerateDelegationTokenPasswordEnabledWithSecretKey(): Unit = {
    val originalProps = new Properties
    originalProps.put("delegation.token.enable", "true")
    originalProps.put(generatorKeyFor(DelegationTokenManagerConfigs.DELEGATION_TOKEN_SECRET_KEY_CONFIG), "echo M4573RK3Y")
    ...
    assertFalse(originalProps.containsKey("delegation.token.enable"))
    assertEquals("M4573RK3Y", generated.getProperty(DelegationTokenManagerConfigs.DELEGATION_TOKEN_SECRET_KEY_CONFIG).trim )
  }

  @Test
  def testGenerateDelegationTokenPasswordEnabledWithBothKeyAndSecretKeyInUse(): Unit = {
    val originalProps = new Properties
    originalProps.put("delegation.token.enable", "true")
    originalProps.put(generatorKeyFor(DelegationTokenManagerConfigs.DELEGATION_TOKEN_SECRET_KEY_CONFIG), "echo M4573RK3Y")
    originalProps.put(generatorKeyFor(DelegationTokenManagerConfigs.DELEGATION_TOKEN_SECRET_KEY_ALIAS_CONFIG), "echo RK3YM4573")
  ...
  def testRunMain(): Unit =  try {
    ...
    expectedProps.put(DelegationTokenManagerConfigs.DELEGATION_TOKEN_SECRET_KEY_ALIAS_CONFIG, "k1")
    ...
    expectedProps.asScala.foreach(k => {
      val key = k._1
    ...
    Exit.setExitProcedure((status: Int, _: String) => assertEquals(0, status))
    ...
    Kafka.runMain(Array("arg1", "arg2"), props, array => {
      ...
      assertEquals(
        ...
        expectedProps.asScala.map(k=> s"${k._1}=${k._2}").toSet
      )
